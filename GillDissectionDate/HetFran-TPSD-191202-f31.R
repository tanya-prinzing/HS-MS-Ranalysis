...
# HetFran-TPSD-191202-f31 GSA Caclculation Script 
...
# Dec 2, 2020 - Tanya Prinzing

# --> UPDATED CALCULATION slightly to move where lam area is doubled, same results
...
GSA_Raw_df <-read_excel("HetFran-TPSD-121202-f31-GSAData.xlsx", sheet="Filaments", col_names = TRUE)
